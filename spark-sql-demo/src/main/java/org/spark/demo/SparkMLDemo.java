...
public class SparkMLDemo {
	public static void main(String[] args) {
	    ...
	    String dataFile = "C:\\Sandeep\\MLData\\iris.data";
        ...
        // 7.1. Model Saving
        model.save(sc.sc(), "C:\\Sandeep\\MLData\\logistic-regression");
        // 7.2. Model Loading
        LogisticRegressionModel sameModel = LogisticRegressionModel.load(sc.sc(), "C:\\Sandeep\\MLData\\logistic-regression");
